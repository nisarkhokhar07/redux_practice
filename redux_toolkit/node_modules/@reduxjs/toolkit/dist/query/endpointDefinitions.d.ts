...
import type { HasRequiredProps, MaybePromise, OmitFromUnion, CastAny, NonUndefined } from './tsHelpers';
...
export declare type TransformedResponse<NewDefinitions extends EndpointDefinitions, K, ResultType> = K extends keyof NewDefinitions ? NewDefinitions[K]['transformResponse'] extends undefined ? ResultType : ReturnType<NonUndefined<NewDefinitions[K]['transformResponse']>> : ResultType;
